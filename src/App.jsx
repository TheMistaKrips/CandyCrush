...
const App = () => {
    ...
    return (
        <div className="app">
            <TonConnectButton style={{padding: 10, alignSelf: 'center'}}/>
            ...
            <div>
                <button style={{padding: 10, margin: 10,alignSelf: 'flex-start', borderRadius: 10, background: '#40a4f0', border: 'none', color: 'white', fontWeight: 'bold', fontSize: 20}}>Shop</button>
                <button style={{padding: 10, margin: 10,alignSelf: 'flex-start', borderRadius: 10, background: '#40a4f0', border: 'none', color: 'white', fontWeight: 'bold', fontSize: 20}}>Mine</button>
                <button style={{padding: 10, margin: 10,alignSelf: 'flex-start', borderRadius: 10, background: '#40a4f0', border: 'none', color: 'white', fontWeight: 'bold', fontSize: 20}}>Games</button>
                <button style={{padding: 10, margin: 10,alignSelf: 'center', borderRadius: 10, background: '#40a4f0', border: 'none', color: 'white', fontWeight: 'bold', fontSize: 20}}>Community</button>
            </div>
        </div>
    )
}
